<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tamaños/</span> Lista</h4>
		...
		<div class="m-t-25">
			<div class="table-responsive">
				<table class="table">
					...
					<tr>
						<th scope="row"><?php echo $size['size_name'] ?></th>
						...
						<td>
							<div class="dropdown dropdown-animated">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="<?php echo base_url() ?>sizes/edit/<?php echo $size['size_id'] ?>"><i class="fa fa-edit text-primary"></i> Editar</a>
									<a class="dropdown-item" href="<?php echo base_url() ?>sizes/delete/<?php echo $size['size_id'] ?>"><i class="fa fa-trash-alt text-danger"></i> Eliminar</a>
								</div>
							</div>
						</td>
					</tr>
