<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Platillos</span> Lista</h4>
		...
		<div class="m-t-25">
			<div class="table-responsive">
				<table id="data-table"  class="table mb-5 table-hover">
					...
					<tr>
						<th scope="row"><?php echo $item['item_name'] ?></th>
						<td  class="">
							<div class="dropdown dropdown-animated">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="<?php echo base_url() ?>items/edit/<?php echo $item['item_id'] ?>"><i class="fa fa-edit text-primary"></i> Editar</a>
									<a class="dropdown-item" href="<?php echo base_url() ?>items/delete/<?php echo $item['item_id'] ?>"><i class="fa fa-trash-alt text-danger"></i> Eliminar</a>
								</div>
							</div>
						</td>
					</tr>
